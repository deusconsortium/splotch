...
OPTIMIZE = -std=c++0x -pedantic -Wno-long-long -Wfatal-errors -Wextra -Wall -Wstrict-aliasing=2 -Wundef -Wshadow -Wwrite-strings -Wredundant-decls -Woverloaded-virtual -Wcast-qual -Wcast-align -Wpointer-arith #-Wold-style-cast
ifeq ($(SYSTYPE),"generic")
# OPTIMIZE += -O2 -g -D TWOGALAXIES
 OPTIMIZE += -O2 -g -fopenmp

#HDF5_HOME = /uddddsr/local/hdf5-1.8.11/
...
FOFReaderSRC= $(wildcard reader/FOFReaderLib/FOFReaderLib/FOFFiles/*.cpp) $(wildcard reader/FOFReaderLib/FOFReaderLib/DEUSSimulation/*.cpp)
...
OBJS  =	kernel/transform.o cxxsupport/error_handling.o \
        reader/mesh_reader.o reader/visivo_reader.o \
	      ...
	      reader/fofcube_reader.o reader/fofstrct_reader.o reader/fofmasst_reader.o \
	      $(FOFReaderSRC:.cpp=.o)
